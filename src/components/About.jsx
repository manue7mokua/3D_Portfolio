    ...
    <>
      ...
      <motion.p
        ...
        className='mt-4 text-secondary text-[17px] max-w-3xl
         leading-[30px]'
      >
        I'm skilled software developer with experience in
        TypeScript and JavaScript, and expertise in frameworks like
        React, Node.js and Three.js. I'm a quick learner and collaborate
        closely with my clients to create efficient, scalable, and 
        user-friendly solutions to solve real-world problems.
